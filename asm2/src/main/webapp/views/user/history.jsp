...
<body>
		...
		<div class="shortcut-links">
			...
			<c:if test="${not empty sessionScope.current_user}">
				...
				<a href="<c:url value='library'/>"><img
					...
					<p>Library</p> </a>
				<a href="history"> <img
					src="<c:url value='templates/user/images/history2.png'/>" alt="">
					<p>History</p>
				</a>
				<a href="playlist"> <img
	...
	<div class="container">
		...
		<h3>List history video You have seen.</h3>
		<div class="list-container1">
			<c:forEach items='${listHisto}' var='item'>
					...
					<div class="flex-div"
						...
						<div class="vid-info">
							<p class="discription"
								...
								href="">${item.title}</p>
							<p style="margin-bottom: 10px">${item.views}&nbsp;views&nbsp;&bull;&nbsp;${item.dayUpload}</p>
